        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/membership" className="text-sm hover:text-primary transition-colors">
                  Membership
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link to="/resources" className="text-sm hover:text-primary transition-colors">
                  Resources
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <div className="flex gap-2">
              <Input
                ...
                className="bg-background/10 border-border text-dark-foreground"
              />
